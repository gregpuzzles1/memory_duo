...
class MemoryDuoPage extends StatefulWidget {
  const MemoryDuoPage({
    super.key,
  ...
  @override
  State<MemoryDuoPage> createState() => _MemoryDuoPageState();
}

class _MemoryDuoPageState extends State<MemoryDuoPage>
  ...
  void _setupLevel(int level) {
    ...
    final List<String> deck =
        _buildNonAdjacentDeck(level, chosen.take(pairCount).toList());
  ...
  Widget _buildCardTile(MemoryCard card, int index) {
    ...
    final Color revealedColor =
        isDarkMode ? dayModeHiddenCubeColor : colorScheme.primaryContainer;
        ...
        child: InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color:
                    card.isMatched ? colorScheme.primary : colorScheme.outlineVariant,
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        for (int rowIndex = 0; rowIndex < rowSizes.length; rowIndex++) {
          ...
          final bool isLastShortRow =
              rowIndex == rowSizes.length - 1 && rowSize < columns;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            tooltip:
                widget.isDarkMode ? 'Switch to Day Mode' : 'Switch to Night Mode',
